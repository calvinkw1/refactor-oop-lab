...
get '/squads/:squad_id/students/:student_id/edit' do
  @student = Student.edit(params[:squad_id].to_i, params[:student_id].to_i)
  erb :'students/edit'
end
...
put '/squads/:squad_id/students/:student_id' do
  stu = Student.find(params[:squad_id].to_i, params[:student_id].to_i)
  stu.name = params[:name]
  stu.age = params[:age]
  stu.spirit_animal = params[:spirit_animal]
  stu.squad_id = params[:squad_id]
  stu.save
  redirect "/squads/#{params[:squad_id].to_i}"
end

delete '/squads/:squad_id/students/:student_id' do
  Student.find(params[:squad_id].to_i, params[:student_id].to_i).destroy
  redirect "/squads/#{params[:squad_id].to_i}"
end
